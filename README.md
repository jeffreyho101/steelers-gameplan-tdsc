...
Note that our final report is a three-page condensed subset of our findings (pdf file), where our full results are all documented in the repository's R code (rmd file). 
